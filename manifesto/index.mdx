...
>
  <Image
    src="/images/manifesto/team.webp"
    alt="team"
    containerClassName="mt-32"
  />
</Hero>

<Hero title="Craftsmanship">
  <Stack className="gap-20 mt-24">
    {[
      ...
      <Flex key={index} className="flex-col md:flex-row gap-4">
        <H3 className="col w-full md:w-5/12 lg:w-1/3 mb-6 md:mb-0">{title}</H3>
        <Paragraph className="col w-full md:w-7/12 text-xl leading-loose">
          {description}
        </Paragraph>
      </Flex>
    ))}
  ...
  <Flex className="mt-24 flex-col sm:flex-row flex-wrap sm:flex-nowrap">
    <div className="col w-full md:w-5/12 lg:w-1/3 mb-16 md:mb-0">
      ...
      <Paragraph className="text-foreground mb-8 text-xl whitespace-pre-line">
        We've been uncovering better ways of developing software by doing it and
        helping others do it. Through this work we have come to value what we
        called "Minifesto".
      </Paragraph>
    </div>
    <Stack className="col w-full md:w-7/12">
      <Stack className="gap-12">
        {[
          ...
          <Flex key={index} className="flex-col gap-0">
            <strong className="block font-semibold text-2xl mb-4 text-primary">
              {title}
            </strong>
...
>
  <Container className="grid grid-cols-2 md:grid-cols-4 gap-8 w-full max-w-none">
    {[
      [
        'Technology',
        ['Go', 'Elixir', 'Swift', 'Flutter', 'ReactJS', 'TypeScript'],
      ],
      ['Platform & Deployment', ['Docker', 'GCP/AWS', 'Kubernetes']],
      [
        ['Architecture', ['Microservices', 'Serverless']],
        ['Emerging', ['Blockchain', 'Hyperledger', 'Practices']],
      ],
      [
        'Agile',
        [
      ...
      Array.isArray(item[0]) ? (
        <Column key={index} className="flex-col gap-4 mb-12">
          <H5>{item[0][0]}</H5>
          <ul className="list-none">
            {item[0][1].map((subItem, subIndex) => (
              <li key={subIndex} className="text-lg leading-loose">
                {subItem}
              </li>
            ))}
          </ul>
...
>
  <Container className="md:flex max-w-none gap-1 pt-8 pb-16">
    {[
      ...
      >
        <Image src={`./svg/${icon}`} alt={title} className="mb-4 h-12" />
        <strong className="text-center mb-4 block text-xl font-semibold leading-tight">
          {title}
        </strong>
        <Paragraph className="text-center text-md whitespace-pre-line leading-loose">
          {description}
        </Paragraph>
      </Flex>
    ))}
  </Container>
  <Link href="/contact" className="text-xl font-medium text-primary">
    Work with us →
  </Link>
</Hero>
  ...
  <Container className="max-w-none">
    ...
    <Flex className="flex-row flex flex-wrap gap-8 lg:flex-nowrap">
      {[
        ...
        <Flex
          key={idx}
          className="gap-2 w-full md:w-1/2 lg:w-1/3 mb-10 lg:mb-0"
        >
