...
<Hero
  ...
  description="Our definition of engineering philosophy, the guiding ideas that shape how we think and work, helps us ensure the core values and deliver top-grade software."
>
  <Image
...
<Hero
  ...
  description={`We quickly respond to changes in the industry and feedbacks from customers without derailing a year's worth of plans. "Just enough" planning and shipping in small, frequent increments lets your team gather feedback on each change and integrate it into future plans at minimal cost.`}
>
...
<Hero title="Tech Radar">
  <Flex className="flex-row flex flex-wrap xl:flex-nowrap justify-between gap-4">
    <Column className="flex-none text-xl mb-4 xl:mb-0 max-w-[35em] leading-loose">
      The Dwarves have a <Link href="/radar" className="font-medium text-primary">spinning radar</Link>. This radar is how we assess and adopt new technology. Throughout the years, we observe the tech industry and pick out the most promising tech to put into the radar to begin the assessment process.
      ...
      Check out the repo <Link href="https://github.com/dwarvesf/radar" className="font-medium text-primary">dwarvesf/radar</Link> to learn more.
    </Column>
