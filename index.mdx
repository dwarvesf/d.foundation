---
title:
description: 'A software development firm based in Asia. Helping tech startups, entrepreneurs and makers build world-class products since 2013.'
---
...
>
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mt-20">
    <Image
      src="./images/home/team-learning.webp"
      alt="team-learning"
      className="hidden sm:block"
    />
    <Image src="./images/home/team-working.webp" alt="team-working" />
    <Image
      src="./images/home/working.webp"
      alt="working"
      className="hidden sm:block"
    />
  </div>
...
<Hero
  ...
  description="Ensuring innovation products has enough capacity to “disrupt” the industry through emerging technology was our mission (and vision) since day one.
...
<Link href="/manifesto" className="text-xl font-medium text-primary">
...
<Hero
  ...
  subtitle="Our work"
  description="From small startups idea to established businesses, we cover areas that are usually hard to get right - from design, branding, development, consulting and offshore. With years of experience and a cultivated engineering culture that focus on building quality products, we take care of the whole product cycle so you can truly focus on the business."
  descriptionClassName="!max-w-4xl"
>
...
>
  <NavigationDropDownContent
    ...
    className="grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mx-0 px-0 !max-w-auto !px-0"
  />
</Hero>
...
<Section>
  <HStack gap="xl">
    <FlexItem className="flex-1 lg:basis-2/3">
      <Image src="./images/home/phoquang-office.jpg" alt="phoquang-office" />
    </FlexItem>
...
<Section className="py-16">
  <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
    {[
      ...
      <Center
        className="h-full lg:h-40 max-h-[60px] lg:max-h-[160px] sm:px-12 px-8"
        key={index}
      >
        <Image
          src={`./images/home/${logo}`}
          alt={logo.replace('.png', '')}
          className="w-auto h-full object-contain relative"
