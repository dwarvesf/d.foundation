...
<Section>
  ...
  <Flex className="flex-col md:flex-row">
    ...
    <Project colored background="dark" customBackgroundColor="#4ABAC6" href="/work/open-fabric" image="/images/work/logo/openfabric-landingpage.webp" imageAlt="Openfabric logo">
      #### Openfabric
