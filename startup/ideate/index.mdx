  ...
  <Column gap="2xl" className="items-center">
    ...
    <div className="mt-6 lg:flex">
      {[
        ...
        <div key={idx} data-index={idx + 1} className="border-alto mt-8 pt-10 w-full lg:w-1/3 dwarves-steps-item">
          <div className="pr-8">
            <h3 className="text-2xl text-primary leading-tight mb-3">
              {section.title}
            </h3>
            <p className="text-lg text-foreground mb-3">{section.description}</p>
            <details>
              <summary className="list-none cursor-default text-lg text-primary hover:text-primary-hover pb-4">Learn more</summary>
...
<Hero>
  <Center className="flex flex-col gap-12">
    ...
    <Flex className="block lg:flex flex-col lg:flex-row xl:mx-auto w-full xl:w-auto">
      ...
      <IdeateForm className="w-full xl:w-1/2 xl:mx-auto" />
    </Flex>
  </Center>
</Hero>
...
<Section fullWidth className="bg-foreground py-12">
  <Container className="dwarves-container">
    <h2 className="flex items-center justify-center text-heading text-muted text-3xl">
      What’s next:
      <Button variant="link" className="inline items-center text-primary text-3xl" href="/startup/validation">
        Validation
        <svg
          stroke="currentColor"
          fill="currentColor"
