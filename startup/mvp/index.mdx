...
<Flex className="flex-col sm:flex-row mt-10">
<Project colored background="light" customBackgroundColor="#FE9579" href="/work/relay" image="/images/work/logo/relay-landingpage.webp" imageAlt="Relay">
  #### Relay
...
<Hero>
  <Center className="flex flex-col gap-12">
    ...
    <Flex className="flex-col lg:flex-row xl:mx-auto w-full">
      ...
      <ContactForm showPolicyAgreement className="w-full xl:w-1/2 mx-auto" />
    </Flex>
