...
<Column gap="2xl" className="mt-16">
  <Flex className="flex-col md:flex-row" gap="2xl">
    ...
    <Project image="../images/home/searchio-logo.png" imageAlt="Search.io logo" href="/work/sajari">
      [Search.io](https://search.io/) provides real-time searching as-a-service and is trusted by large businesses worldwide. Partnering with Dwarves helps Sajari to enhance their development team to refactor their Console dashboard app, improving quality of open-source packages as well as tailoring brand UI for plugin consumers.
    </Project>
