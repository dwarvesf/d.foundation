---
title: 'Mudah'
description: "Upgrading Malaysia's largest online marketplace"
template: work-detail
hero-image: assets/mudah-main.webp
thumbnail: 'assets/mudah-main.webp'
metadata:
  industry: E-commerce / Online Marketplace
  location: Malaysia
  business-context: Established marketplace needed to modernize legacy systems to support growth
  solution: Migrated from monolithic PHP to a microservice architecture with modern technologies
  outcome: Delivered a faster, more reliable platform that improved user experience and business growth
  our-service: System Architecture / Backend / Frontend / Mobile
hero-mdx-content: "
[Mudah.my](https://www.mudah.my/) is Malaysia's biggest online marketplace. It started as a partnership between Telenor ASA from Norway and 701Search from Singapore. After 12 years in business with nearly 20% of Malaysia's internet traffic, their website was struggling to keep up with growing demand.
