...
description: "Building a powerful crypto trading dashboard for professionals"
template: work-detail
hero-image: assets/hedge-main.webp
thumbnail: 'assets/hedge-main.webp'
metadata:
  industry: Financial Technology / Cryptocurrency
  location: Global
  business-context: Pro traders needed a unified system to manage multiple exchange accounts
  solution: Built a dashboard to sync data and automate trading
  outcome: Reduced time spent managing multiple accounts
  our-service: Full-stack Dev / Financial Systems / Data Visualization
hero-mdx-content: "
...
![Hedge Foundation crypto trading dashboard](assets/hedge-stategies.webp)
