...
hero-image: assets/droppiivietnam-cover.webp
metadata:
  industry: E-commerce
  location: Vietnam and Southeast Asia
  business-context: Needed a better e-commerce platform to make dropshipping operations simpler and more efficient
  solution: Built a modern, upgraded online system with improved user experience and business tools
  outcome: Successfully launched Droppii for Business v3.0 that business users love, with better controls and insights for managing their operations
  our-service: Full-stack development / Agile project management
hero-mdx-content: "
[Droppii](https://www.droppii.com/) teamed up with us to improve their e-commerce platform for dropshipping businesses. We built a new version called Droppii for Business v3.0 that's easier to use and helps businesses manage their operations better. 

The new platform includes a cleaner dashboard, better content management, and improved business tools. This upgrade has helped Droppii grow in the competitive e-commerce market and deliver more value to their users.
