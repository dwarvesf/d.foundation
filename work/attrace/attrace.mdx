...
hero-image: /work/attrace/assets/attrace-landingpage.webp
metadata:
...
> <Paragraph className=\"not-italic\">\"After 3 months, they left us with great development and improvement, in terms of work result and team synchronization. A worthy evidence for Attrace’s investments and we hope nothing more than to keep going with them in long-term, provide opportunities for these devs to grow with Attrace.\"</Paragraph>
  <HStack className=\"items-center mt-4\">
    <Image src=\"work/attrace/assets/erwin-werring_l1xhfg.webp\" className=\"rounded-full h-12 w-12\" />
    <Stack gap=\"xs\">
      <Paragraph className=\"not-italic text-md font-semibold\">Erwin</Paragraph>
...
### [Challenge](https://dwarves.foundation/work/attrace#challenge)
...
![](/work/attrace/assets/attrace-challenges.webp)
...
### [Solution](https://dwarves.foundation/work/attrace#solution)
...
#### [Technical Diagnosis](https://dwarves.foundation/work/attrace#technical-diagnosis)
...
#### [Implemetation](https://dwarves.foundation/work/attrace#implemetation)
...
![](/work/attrace/assets/attrace-example.webp)
...
#### [Tech Stacks](https://dwarves.foundation/work/attrace#tech-stacks)
...
#### [Engagement](https://dwarves.foundation/work/attrace#engagement)
...
### [Outcome](https://dwarves.foundation/work/attrace#outcome)
