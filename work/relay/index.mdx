---
title: 'Relay'
description: "Helping Relay launch their workflow automation MVP for the US market"
template: work-detail
hero-image: assets/relay-logo-banner.webp
thumbnail: 'assets/relay-logo-banner.webp'
metadata:
  industry: Productivity tools
  location: United States
  business-context: Needed to launch MVP quickly for market testing
  solution: Built Chrome extension and Slack integration with clean, flexible codebase
  outcome: Gained early customers and enabled next funding round
  our-service: Full-stack dev / Agile project management
hero-mdx-content: "
[Relay](https://teamrelay.com/) is a workflow automation tool that helps teams streamline their processes and improve productivity. They needed to quickly build and launch their MVP to test the US market and acquire early users.


Relay's product owner, Hetong, made it clear they needed a basic but viable version with essential features to test in the market. We provided two adaptable engineers who worked closely with Relay to develop and ship features at a steady pace. The result was a successful MVP launch that included a Chrome extension, web app, analytics dashboard, and Slack integration, which helped Relay gain their first paying customers and prepare for their funding round.


We provided two adaptable engineers who worked closely with Relay to develop and ship features at a steady pace. The result was a successful MVP launch that included a Chrome extension, web app, analytics dashboard, and Slack integration, which helped Relay gain their first paying customers and prepare for their funding round.
