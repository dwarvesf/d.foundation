...
hero-mdx-content: "
[Screenz.ai](https://screenz.ai/) is an innovative HR tech startup focused on transforming recruitment through AI. They approached us to build a minimum viable product (MVP) that would allow them to test their vision of an automated hiring platform capable of conducting voice interviews and providing real-time candidate evaluations.
