...
metadata:
  ...
  business-context: A startup needed a fast, fair, and scalable AI recruitment tool to streamline hiring processes for HR teams
  solution: Designed and delivered a MVP for an AI-powered hiring platform in two weeks, enabling rapid market validation
  outcome: Successfully launched an intuitive, voice-enabled hiring tool, slashing screening times and positioning Screenz.ai for growth in HR tech
  our-service: Product Design, UI/UX, Prototyping, Backend Development, User Research
hero-mdx-content: "
