---
title: 'Kafi Design'
description: "Making stock trading easier for everyone"
template: work-detail
hero-image: assets/kafi-cover.webp
thumbnail: 'assets/kafi-cover.webp'
metadata:
  industry: Financial Services / Investment
  location: Vietnam
  business-context: Trading app needed a redesign to engage beginners while supporting pro users
  solution: Reimagined the user journey with tiered experience levels and embedded education
  outcome: Increased retention and usability across diverse trader segments
  our-service: UX/UI Design / User Research / Mobile App Redesign
hero-mdx-content: "
Kafi Design is a mobile-first stock trading platform tailored to the needs of Vietnam’s growing investor base. We worked with Kafi Securities to redesign their mobile app from the ground up, creating a seamless, modern trading experience that adapts to both first-time investors and seasoned professionals. The redesign aimed to reduce friction, onboard new users more effectively, and provide pro-level tools without sacrificing usability.


In early 2024, following a strong financial year, Kafi recognized the need to invest in better technology to stay competitive. They partnered with us to rebuild their trading app and position themselves as a leader in the Vietnamese fintech market.


![](assets/kafi-mobile.webp)
...
![](assets/kafi-designing-tools-for-different-user-groups.webp)
...
![](assets/kafi-helping-new-investors.webp)

![](assets/kafi-helping-new-investors-2.webp)
