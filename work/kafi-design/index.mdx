...
hero-mdx-content: "
Kafi Design is the refreshed trading platform experience for a Vietnam-based brokerage firm. We revamped the mobile app interface to onboard new investors while giving pro users the speed and depth they need — all through adaptive flows, contextual learning, and intuitive designn.
