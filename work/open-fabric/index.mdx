---
title: 'Open Fabric'
description: "Building a payment platform from scratch"
template: work-detail
hero-image: assets/open-fabric-main.webp
thumbnail: 'assets/open-fabric-main.webp'
metadata:
  industry: Financial Technology
  location: Singapore
  business-context: Payment startup needed to build a secure, scalable platform from scratch
  solution: Developed a multi-tenant cloud platform that connects merchants with payment providers
  outcome: Successfully launched the platform within one year, enabling expansion in Southeast Asia
...
![](assets/open-fabric-solution.webp)
"
links:
  previous:
    title: 'Mudah'
