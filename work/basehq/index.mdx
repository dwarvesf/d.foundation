---
title: 'BaseHQ'
description: "Creating the first platform for Executive assistants"
template: work-detail
hero-image: assets/basehq-main.webp
thumbnail: 'assets/basehq-main.webp'
metadata:
  industry: Productivity / Workplace Software
  location: United States
  business-context: Executive assistants needed a single tool to handle calendars, tasks, and communications.
  solution: Developed a platform tailored to their workflow
  outcome: Simplified daily tasks and built an ongoing technical partnership
  our-service: Full-stack Dev / Technical Consulting / Code Quality Improvement
hero-mdx-content: "
[Base](https://basehq.com/) is a software platform made specifically for executive assistants. It launched in 2019 with $2.6 million in funding from investors like Matchstick Ventures, Rise of the Rest Seed Fund, High Alpha Capital, and Slack Fund. Their goal was to change how executive assistants work.


Executive assistants juggle many tasks every day, from managing calendars and scheduling meetings to tracking decisions and creating reports. Before Base, there wasn't any software designed specifically for their needs.
...
- **User application**: The interface that executive assistants use every day
- **Admin tools**: Backend systems for managing users, connections, and platform settings
